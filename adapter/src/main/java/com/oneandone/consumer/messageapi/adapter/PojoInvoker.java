 ...
 * classes generated by the {@link ApiToMessagePojoProcessor} back to method calls.
 */
public class PojoInvoker<T> {
    ...
    private void invoke(Method method, List<Parameter> methodParameters,
        ...
        try {
            method.invoke(impl, getArgs(method, methodParameters, pojoProperties));
    ...
    private Object[] getArgs(Method method, List<Parameter> methodParameters,
            PojoProperties pojoProperties) {
